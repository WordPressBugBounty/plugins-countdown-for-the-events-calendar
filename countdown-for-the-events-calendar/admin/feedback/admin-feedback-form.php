...
class tecc_feedback {
	...
	private $plugin_url     = TECC_PLUGIN_URL;
	private $plugin_version = TECC_VERSION_CURRENT;
	private $plugin_name    = 'The Events Calendar Countdown Addon';
	private $plugin_slug    = 'tecc';
	...
	*/
	...
	function submit_deactivation_response() {
		...
		if ( ! isset( $_POST['_wpnonce'] ) || ! wp_verify_nonce( sanitize_text_field( wp_unslash( $_POST['_wpnonce'] ) ), '_cool-plugins_deactivate_feedback_nonce' ) ) {
			...
			$plugin_initial     = get_option( 'tecc_initial_save_version' );
			...
			$feedback_url       = TECC_FEEDBACK_API .'wp-json/coolplugins-feedback/v1/feedback';
